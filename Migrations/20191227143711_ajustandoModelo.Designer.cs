...
namespace GoTravelTour.Migrations
{
    ...
    [Migration("20191227143711_ajustandoModelo")]
    partial class ajustandoModelo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoTravelTour.Models.ContratoProducto", b =>
                {
                    b.Property<int>("ContratoProductoId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ContratoProductoId");

                    b.HasIndex("ContratoId");

                    b.HasIndex("ProductoId");

                    b.ToTable("ContratoProducto");
                });
            ...
            modelBuilder.Entity("GoTravelTour.Models.ContratoProducto", b =>
                {
                    b.HasOne("GoTravelTour.Models.Contrato", "Contrato")
                        .WithMany("ListaProductosEnContratos")
            ...
            modelBuilder.Entity("GoTravelTour.Models.NombreTemporada", b =>
                {
                    b.HasOne("GoTravelTour.Models.Contrato")
                        .WithMany("NombreTemporadas")
                        .HasForeignKey("ContratoId");
                });
