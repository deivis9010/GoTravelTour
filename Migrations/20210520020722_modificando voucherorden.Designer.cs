...
namespace GoTravelTour.Migrations
{
    ...
    [Migration("20210520020722_modificando voucherorden")]
    partial class modificandovoucherorden
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoTravelTour.Models.ConfiguracionVoucher", b =>
                {
                    ...
                    b.Property<string>("ImageCompania");
            ...
            modelBuilder.Entity("GoTravelTour.Models.Contrato", b =>
                {
                    ...
                    b.Property<bool>("PrecioAlojamientoPorHabitacion");
            ...
            modelBuilder.Entity("GoTravelTour.Models.DatosPasajeroPrimario", b =>
                {
                    ...
                    b.Property<int?>("LicenciasOFACId");
            ...
            modelBuilder.Entity("GoTravelTour.Models.LicenciasOFAC", b =>
                {
                    b.Property<int>("LicenciasOFACId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("LicenciasOFACId");

                    b.ToTable("LicenciasOFAC");
                });
            ...
            modelBuilder.Entity("GoTravelTour.Models.Orden", b =>
                {
                    ...
                    b.Property<int>("CantidadAdulto");

                    b.Property<int>("CantidadInfante");

                    b.Property<int>("CantidadNino");

                    b.Property<int>("ClienteId");

                    b.Property<bool>("ConfirmacionOrden");

                    b.Property<int?>("CreadorUsuarioId");

                    b.Property<string>("Estado");

                    b.Property<bool>("EstimatedCreated");
                    ...
                    b.Property<int>("IdEstimadoQB");

                    b.Property<int>("IdInvoiceQB");
            ...
            modelBuilder.Entity("GoTravelTour.Models.OrdenActividad", b =>
                {
                    ...
                    b.Property<int?>("LugarActividadRegionId");
                    ...
                    b.HasIndex("LugarActividadRegionId");
            ...
            modelBuilder.Entity("GoTravelTour.Models.OrdenAlojamiento", b =>
                {
                    ...
                    b.Property<int?>("ModificadorAplicadoModificadorId");
                    ...
                    b.HasIndex("ModificadorAplicadoModificadorId");
            ...
            modelBuilder.Entity("GoTravelTour.Models.OrdenAlojamientoPrecioAlojamiento", b =>
                {
                    b.Property<int>("OrdenAlojamientoPrecioAlojamientoId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("OrdenAlojamientoPrecioAlojamientoId");

                    b.HasIndex("OrdenAlojamientoId");

                    b.HasIndex("PrecioAlojamientoId");

                    b.ToTable("OrdenAlojamientoPrecioAlojamiento");
                });

            modelBuilder.Entity("GoTravelTour.Models.OrdenServicioAdicional", b =>
                {
                    b.Property<int>("OrdenServicioAdicionalId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<decimal>("PrecioNinos");
                    ...
                    b.Property<string>("TipoViajeBoleto");

                    b.Property<decimal>("TotalPersonas");

                    b.Property<decimal>("TotalPrecioAdultos");

                    b.Property<decimal>("TotalPrecioInfantes");

                    b.Property<decimal>("TotalPrecioNinos");
            ...
            modelBuilder.Entity("GoTravelTour.Models.OrdenTraslado", b =>
                {
                    ...
                    b.Property<string>("TipoTrasladoOrden");
            ...
            modelBuilder.Entity("GoTravelTour.Models.OrdenVehiculoPrecioRentaAuto", b =>
                {
                    b.Property<int>("OrdenVehiculoPrecioRentaAutoId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("OrdenVehiculoPrecioRentaAutoId");

                    b.HasIndex("OrdenVehiculoId");

                    b.HasIndex("PrecioRentaAutosId");

                    b.ToTable("OrdenVehiculoPrecioRentaAuto");
                });
            ...
            modelBuilder.Entity("GoTravelTour.Models.PreciosOrdenModificados", b =>
                {
                    b.Property<int>("PreciosOrdenModificadosId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("PreciosOrdenModificadosId");

                    b.ToTable("PreciosOrdenModificados");
                });
            ...
            modelBuilder.Entity("GoTravelTour.Models.TipoServicioAdicional", b =>
                {
                    b.Property<int>("TipoServicioAdicionalId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("Nombre");

                    b.HasKey("TipoServicioAdicionalId");

                    b.ToTable("TipoServicioAdicional");
                });
            ...
            modelBuilder.Entity("GoTravelTour.Models.VoucherOrden", b =>
                {
                    b.Property<int>("VoucherOrdenId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("VoucherOrdenId");

                    b.ToTable("VoucherOrden");
                });
            ...
            modelBuilder.Entity("GoTravelTour.Models.ServicioAdicional", b =>
                {
                    b.HasBaseType("GoTravelTour.Models.Producto");
                    ...
                    b.HasIndex("TipoServicioAdicionalId");

                    b.ToTable("ServicioAdicional");

                    b.HasDiscriminator().HasValue("ServicioAdicional");
                });
            ...
            modelBuilder.Entity("GoTravelTour.Models.DatosPasajeroPrimario", b =>
                {
                    b.HasOne("GoTravelTour.Models.LicenciasOFAC", "LicenciasOFAC")
                        .WithMany()
                        .HasForeignKey("LicenciasOFACId");
            ...
            modelBuilder.Entity("GoTravelTour.Models.OrdenActividad", b =>
                {
                    ...
                    b.HasOne("GoTravelTour.Models.Region", "LugarActividad")
                        .WithMany()
                        .HasForeignKey("LugarActividadRegionId");
            ...
            modelBuilder.Entity("GoTravelTour.Models.OrdenAlojamiento", b =>
                {
                    ...
                    b.HasOne("GoTravelTour.Models.Modificador", "ModificadorAplicado")
                        .WithMany()
                        .HasForeignKey("ModificadorAplicadoModificadorId");
            ...
            modelBuilder.Entity("GoTravelTour.Models.OrdenAlojamientoPrecioAlojamiento", b =>
                {
                    b.HasOne("GoTravelTour.Models.OrdenAlojamiento", "OrdenAlojamiento")
                        .WithMany("ListaPrecioAlojamientos")
                        .HasForeignKey("OrdenAlojamientoId");
            ...
            modelBuilder.Entity("GoTravelTour.Models.OrdenServicioAdicional", b =>
                {
                    ...
                    b.HasOne("GoTravelTour.Models.Orden", "Orden")
                        .WithMany("ListaOrdenServicioAdicional")
                        .HasForeignKey("OrdenId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("GoTravelTour.Models.OrdenVehiculoPrecioRentaAuto", b =>
                {
                    b.HasOne("GoTravelTour.Models.OrdenVehiculo", "OrdenVehiculo")
                        .WithMany("ListaPreciosRentaAutos")
                        .HasForeignKey("OrdenVehiculoId");
            ...
            modelBuilder.Entity("GoTravelTour.Models.ServicioAdicional", b =>
                {
                    b.HasOne("GoTravelTour.Models.TipoServicioAdicional", "TipoServicioAdicional")
                        .WithMany()
                        .HasForeignKey("TipoServicioAdicionalId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
